...
let constructor = function (app) {
    ...
    let replaceDependenciesVersions = function (source, target, dev_target) {
        ...
        for (i in source) {
            ...
            if (((i in target) && target[i] === version) || ((i in dev_target) && dev_target[i] === version)) {
            ...
            getPackageName(package_name)
                    .then(result => {
                        ...
                        packages.forEach(package_data => {
                            ...
                            [dependencies, dev_dependencies] = loadAllDependenciesVersions(package_name, dependencies, dev_dependencies);
                        });
